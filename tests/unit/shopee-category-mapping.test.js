...
test("separa figures e organizadores por finalidade", () => {
  assert.match(suggestShopeeCategory({ sku: "DEC-4016768", title: "Figure Mewtwo Pokémon" }).path, /Figuras de Ação$/);
  assert.match(suggestShopeeCategory({ sku: "ORG-1818556", title: "Porta Pincéis de Maquiagem" }).path, /Acessórios de Maquiagem$/);
